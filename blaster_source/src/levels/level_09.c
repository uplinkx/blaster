...
t_wave_m	level_09(void)
{
	...
	level_09.waves[4] = (t_wave){0, WAVE_PREV_DEFEAT, 0, SDL_FALSE, SDL_FALSE, 60, SDL_FALSE, NULL};
	...
	// level_09.waves[4].wave_array[4] =  (t_wave_elem){E_SLIME_CYAN, 0, 40, SDL_TRUE, {0, a * 4}, 0};
	// level_09.waves[4].wave_array[5] =  (t_wave_elem){E_SLIME_CYAN, 0, 40, SDL_TRUE, {0, a * 5}, 0};
	// level_09.waves[4].wave_array[6] =  (t_wave_elem){E_SLIME_CYAN, 0, 40, SDL_TRUE, {0, a * 6}, 0};
	level_09.waves[4].wave_array[7] =  (t_wave_elem){E_SLIME_CYAN, 0, 40, SDL_TRUE, {0, a * 7}, 0};
	level_09.waves[4].wave_array[8] =  (t_wave_elem){E_SLIME_CYAN, 0, 40, SDL_TRUE, {0, a * 8}, 0};
	level_09.waves[4].wave_array[9] =  (t_wave_elem){E_SLIME_CYAN, 0, 40, SDL_TRUE, {0, a * 9}, 0};
	level_09.waves[4].wave_array[10] = (t_wave_elem){E_SLIME_CYAN, 0, 40, SDL_TRUE, {0, a * 10}, 0};
	// level_09.waves[4].wave_array[11] = (t_wave_elem){E_SLIME_CYAN, 0, 40, SDL_TRUE, {0, a * 11}, 0};
	// level_09.waves[4].wave_array[12] = (t_wave_elem){E_SLIME_CYAN, 0, 40, SDL_TRUE, {0, a * 12}, 0};
	// level_09.waves[4].wave_array[13] = (t_wave_elem){E_SLIME_CYAN, 0, 40, SDL_TRUE, {0, a * 13}, 0};
	level_09.waves[4].wave_array[14] = (t_wave_elem){E_SLIME_CYAN, 0, 40, SDL_TRUE, {0, a * 14}, 0};
	level_09.waves[4].wave_array[15] = (t_wave_elem){E_SLIME_CYAN, 0, 40, SDL_TRUE, {0, a * 15}, 0};
	level_09.waves[4].wave_array[16] = (t_wave_elem){E_SLIME_CYAN, 0, 40, SDL_TRUE, {0, a * 16}, 0};
	// level_09.waves[4].wave_array[17] = (t_wave_elem){E_SLIME_CYAN, 0, 40, SDL_TRUE, {0, a * 17}, 0};
	// level_09.waves[4].wave_array[18] = (t_wave_elem){E_SLIME_CYAN, 0, 40, SDL_TRUE, {0, a * 18}, 0};
	// level_09.waves[4].wave_array[19] = (t_wave_elem){E_SLIME_CYAN, 0, 40, SDL_TRUE, {0, a * 19}, 0};

	level_09.waves[4].wave_array[20] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 0}, 0};
	level_09.waves[4].wave_array[21] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 1}, 0};
	level_09.waves[4].wave_array[22] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 2}, 0};
	level_09.waves[4].wave_array[23] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 3}, 0};
	// level_09.waves[4].wave_array[24] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 4}, 0};
	// level_09.waves[4].wave_array[25] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 5}, 0};
	// level_09.waves[4].wave_array[26] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 6}, 0};
	level_09.waves[4].wave_array[27] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 7}, 0};
	level_09.waves[4].wave_array[28] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 8}, 0};
	level_09.waves[4].wave_array[29] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 9}, 0};
	level_09.waves[4].wave_array[30] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 10}, 0};
	// level_09.waves[4].wave_array[31] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 11}, 0};
	// level_09.waves[4].wave_array[32] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 12}, 0};
	// level_09.waves[4].wave_array[33] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 13}, 0};
	level_09.waves[4].wave_array[34] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 14}, 0};
	level_09.waves[4].wave_array[35] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 15}, 0};
	level_09.waves[4].wave_array[36] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 16}, 0};
	// level_09.waves[4].wave_array[37] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 17}, 0};
	// level_09.waves[4].wave_array[38] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 18}, 0};
	// level_09.waves[4].wave_array[39] = (t_wave_elem){E_SLIME_CYAN, 0, 70, SDL_TRUE, {0, a * 19}, 0};

	level_09.waves[4].wave_array[40] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 0}, 0};
	level_09.waves[4].wave_array[41] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 1}, 0};
	level_09.waves[4].wave_array[42] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 2}, 0};
	level_09.waves[4].wave_array[43] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 3}, 0};
	// level_09.waves[4].wave_array[44] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 4}, 0};
	// level_09.waves[4].wave_array[45] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 5}, 0};
	// level_09.waves[4].wave_array[46] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 6}, 0};
	level_09.waves[4].wave_array[47] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 7}, 0};
	level_09.waves[4].wave_array[48] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 8}, 0};
	level_09.waves[4].wave_array[49] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 9}, 0};
	level_09.waves[4].wave_array[50] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 10}, 0};
	// level_09.waves[4].wave_array[51] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 11}, 0};
	// level_09.waves[4].wave_array[52] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 12}, 0};
	// level_09.waves[4].wave_array[53] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 13}, 0};
	level_09.waves[4].wave_array[54] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 14}, 0};
	level_09.waves[4].wave_array[55] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 15}, 0};
	level_09.waves[4].wave_array[56] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 16}, 0};
	// level_09.waves[4].wave_array[57] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 17}, 0};
	// level_09.waves[4].wave_array[58] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 18}, 0};
	// level_09.waves[4].wave_array[59] = (t_wave_elem){E_SLIME_CYAN, 0, 100, SDL_TRUE, {0, a * 19}, 0};
