...
t_wave_m	level_05(void)
{
	...
	t = 15;
	level_05.waves[2].wave_array[0] =  (t_wave_elem){E_SLIME_BLUE, 0, 31 * t, SDL_TRUE, {0, 0}, 0};
	level_05.waves[2].wave_array[1] =  (t_wave_elem){E_SLIME_BLUE, 0, 18 * t, SDL_TRUE, {0, 10}, 0};
	level_05.waves[2].wave_array[2] =  (t_wave_elem){E_SLIME_BLUE, 0, 27 * t, SDL_TRUE, {0, 20}, 0};
	level_05.waves[2].wave_array[3] =  (t_wave_elem){E_SLIME_BLUE, 0, 22 * t, SDL_TRUE, {0, 30}, 0};
	level_05.waves[2].wave_array[4] =  (t_wave_elem){E_SLIME_BLUE, 0, 36 * t, SDL_TRUE, {0, 40}, 0};
	...
	level_05.waves[2].wave_array[7] =  (t_wave_elem){E_SLIME_BLUE, 0, 16 * t, SDL_TRUE, {0, 70}, 0};
	level_05.waves[2].wave_array[8] =  (t_wave_elem){E_SLIME_BLUE, 0, 28 * t, SDL_TRUE, {0, 80}, 0};
	level_05.waves[2].wave_array[9] =  (t_wave_elem){E_SLIME_BLUE, 0, 12 * t, SDL_TRUE, {0, 90}, 0};
	level_05.waves[2].wave_array[10] = (t_wave_elem){E_SLIME_BLUE, 0, 13 * t, SDL_TRUE, {0, 100}, 0};
	level_05.waves[2].wave_array[11] = (t_wave_elem){E_SLIME_BLUE, 0, 26 * t, SDL_TRUE, {0, 110}, 0};
	...
	level_05.waves[2].wave_array[14] = (t_wave_elem){E_SLIME_BLUE, 0, 6 * t, SDL_TRUE, {0, 140}, 0};
	level_05.waves[2].wave_array[15] = (t_wave_elem){E_SLIME_BLUE, 0, 20 * t, SDL_TRUE, {0, 150}, 0};
	level_05.waves[2].wave_array[16] = (t_wave_elem){E_SLIME_BLUE, 0, 25 * t, SDL_TRUE, {0, 160}, 0};
	level_05.waves[2].wave_array[17] = (t_wave_elem){E_SLIME_BLUE, 0, 35 * t, SDL_TRUE, {0, 170}, 0};
	level_05.waves[2].wave_array[18] = (t_wave_elem){E_SLIME_BLUE, 0, 33 * t, SDL_TRUE, {0, 180}, 0};
	level_05.waves[2].wave_array[19] = (t_wave_elem){E_SLIME_BLUE, 0, 34 * t, SDL_TRUE, {0, 190}, 0};
	level_05.waves[2].wave_array[20] = (t_wave_elem){E_SLIME_BLUE, 0, 29 * t, SDL_TRUE, {0, 200}, 0};
	level_05.waves[2].wave_array[21] = (t_wave_elem){E_SLIME_BLUE, 0, 8 * t, SDL_TRUE, {0, 210}, 0};
	level_05.waves[2].wave_array[22] = (t_wave_elem){E_SLIME_BLUE, 0, 3 * t, SDL_TRUE, {0, 220}, 0};
	level_05.waves[2].wave_array[23] = (t_wave_elem){E_SLIME_BLUE, 0, 5 * t, SDL_TRUE, {0, 230}, 0};
	...
	level_05.waves[2].wave_array[27] = (t_wave_elem){E_SLIME_BLUE, 0, 11 * t, SDL_TRUE, {0, 270}, 0};
	level_05.waves[2].wave_array[28] = (t_wave_elem){E_SLIME_BLUE, 0, 4 * t, SDL_TRUE, {0, 280}, 0};
	level_05.waves[2].wave_array[29] = (t_wave_elem){E_SLIME_BLUE, 0, 19 * t, SDL_TRUE, {0, 290}, 0};
	level_05.waves[2].wave_array[29] = (t_wave_elem){E_SLIME_BLUE, 0, 2 * t, SDL_TRUE, {0, 290}, 0};
	level_05.waves[2].wave_array[30] = (t_wave_elem){E_SLIME_BLUE, 0, 17 * t, SDL_TRUE, {0, 300}, 0};
	...
	level_05.waves[2].wave_array[33] = (t_wave_elem){E_SLIME_BLUE, 0, 23 * t, SDL_TRUE, {0, 330}, 0};
	level_05.waves[2].wave_array[34] = (t_wave_elem){E_SLIME_BLUE, 0, 15 * t, SDL_TRUE, {0, 340}, 0};
