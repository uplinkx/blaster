...
t_wave_m	level_11(void)
{
	...
	level_11.waves[3].wave_array[10] =  (t_wave_elem){E_SLIME_CYAN, 0, 20 + t * 0,  SDL_TRUE, {0, 0 * a + 10}, 0};
	level_11.waves[3].wave_array[11] =  (t_wave_elem){E_SLIME_CYAN, 0, 20 + t * 0,  SDL_TRUE, {0, 1 * a + 10}, 0};
	level_11.waves[3].wave_array[12] =  (t_wave_elem){E_SLIME_CYAN, 0, 20 + t * 0,  SDL_TRUE, {0, 2 * a + 10}, 0};
	level_11.waves[3].wave_array[13] =  (t_wave_elem){E_SLIME_CYAN, 0, 20 + t * 0,  SDL_TRUE, {0, 3 * a + 10}, 0};
	level_11.waves[3].wave_array[14] =  (t_wave_elem){E_SLIME_CYAN, 0, 20 + t * 0,  SDL_TRUE, {0, 4 * a + 10}, 0};
	level_11.waves[3].wave_array[15] =  (t_wave_elem){E_SLIME_CYAN, 0, 20 + t * 0,  SDL_TRUE, {0, 5 * a + 10}, 0};
	level_11.waves[3].wave_array[16] =  (t_wave_elem){E_SLIME_CYAN, 0, 20 + t * 0,  SDL_TRUE, {0, 6 * a + 10}, 0};
	level_11.waves[3].wave_array[17] =  (t_wave_elem){E_SLIME_CYAN, 0, 20 + t * 0,  SDL_TRUE, {0, 7 * a + 10}, 0};
	level_11.waves[3].wave_array[18] =  (t_wave_elem){E_SLIME_CYAN, 0, 20 + t * 0,  SDL_TRUE, {0, 8 * a + 10}, 0};
	level_11.waves[3].wave_array[19] =  (t_wave_elem){E_SLIME_CYAN, 0, 20 + t * 0,  SDL_TRUE, {0, 9 * a + 10}, 0};

	level_11.waves[3].wave_array[20] =  (t_wave_elem){E_SLIME_CYAN, 0, 40 + t * 0,  SDL_TRUE, {0, 0 * a + 20}, 0};
	level_11.waves[3].wave_array[21] =  (t_wave_elem){E_SLIME_CYAN, 0, 40 + t * 0,  SDL_TRUE, {0, 1 * a + 20}, 0};
	level_11.waves[3].wave_array[22] =  (t_wave_elem){E_SLIME_CYAN, 0, 40 + t * 0,  SDL_TRUE, {0, 2 * a + 20}, 0};
	level_11.waves[3].wave_array[23] =  (t_wave_elem){E_SLIME_CYAN, 0, 40 + t * 0,  SDL_TRUE, {0, 3 * a + 20}, 0};
	level_11.waves[3].wave_array[24] =  (t_wave_elem){E_SLIME_CYAN, 0, 40 + t * 0,  SDL_TRUE, {0, 4 * a + 20}, 0};
	level_11.waves[3].wave_array[25] =  (t_wave_elem){E_SLIME_CYAN, 0, 40 + t * 0,  SDL_TRUE, {0, 5 * a + 20}, 0};
	level_11.waves[3].wave_array[26] =  (t_wave_elem){E_SLIME_CYAN, 0, 40 + t * 0,  SDL_TRUE, {0, 6 * a + 20}, 0};
	level_11.waves[3].wave_array[27] =  (t_wave_elem){E_SLIME_CYAN, 0, 40 + t * 0,  SDL_TRUE, {0, 7 * a + 20}, 0};
	level_11.waves[3].wave_array[28] =  (t_wave_elem){E_SLIME_CYAN, 0, 40 + t * 0,  SDL_TRUE, {0, 8 * a + 20}, 0};
	level_11.waves[3].wave_array[29] =  (t_wave_elem){E_SLIME_CYAN, 0, 40 + t * 0,  SDL_TRUE, {0, 9 * a + 20}, 0};

	level_11.waves[3].wave_array[30] =  (t_wave_elem){E_SLIME_PURP, 0, 60 + t * 0,  SDL_TRUE, {0, 90 + 120}, 0};
	level_11.waves[3].wave_array[31] =  (t_wave_elem){E_SLIME_CYAN, 0, 60 + t * 0,  SDL_TRUE, {0, 90 + 120}, 0};
	level_11.waves[3].wave_array[32] =  (t_wave_elem){E_SLIME_PURP, 0, 60 + t * 0,  SDL_TRUE, {0, 90 + 240}, 0};
	level_11.waves[3].wave_array[33] =  (t_wave_elem){E_SLIME_CYAN, 0, 60 + t * 0,  SDL_TRUE, {0, 90 + 240}, 0};
	level_11.waves[3].wave_array[34] =  (t_wave_elem){E_SLIME_PURP, 0, 60 + t * 0,  SDL_TRUE, {0, 90 + 0}, 0};
	level_11.waves[3].wave_array[35] =  (t_wave_elem){E_SLIME_CYAN, 0, 60 + t * 0,  SDL_TRUE, {0, 90 + 0}, 0};
