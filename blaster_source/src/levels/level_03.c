...
t_wave_m	level_03(void)
{
	...
	level_03.waves[0] = (t_wave){0, WAVE_TICKS, 0, SDL_FALSE, SDL_TRUE, 15, SDL_FALSE, NULL};
	...
	level_03.waves[0].wave_array[6] =  (t_wave_elem){E_SLIME_BLUE, 0, 70, SDL_TRUE, {0, 90 + 35}, 0};
	level_03.waves[0].wave_array[7] =  (t_wave_elem){E_SLIME_BLUE, 0, 70, SDL_TRUE, {0, 90 }, 0};
	level_03.waves[0].wave_array[8] =  (t_wave_elem){E_SLIME_BLUE, 0, 70, SDL_TRUE, {0, 90 - 35}, 0};

	level_03.waves[0].wave_array[9] =  (t_wave_elem){E_SLIME_BLUE, 0, 100, SDL_TRUE, {0, 270 + 35}, 0};
	level_03.waves[0].wave_array[10] = (t_wave_elem){E_SLIME_BLUE, 0, 100, SDL_TRUE, {0, 270 }, 0};
	level_03.waves[0].wave_array[11] = (t_wave_elem){E_SLIME_BLUE, 0, 100, SDL_TRUE, {0, 270 - 35}, 0};

	level_03.waves[0].wave_array[12] =  (t_wave_elem){E_SLIME_BLUE, 0, 125, SDL_TRUE, {0, 270 + 45}, 0};
	level_03.waves[0].wave_array[13] = (t_wave_elem){E_SLIME_BLUE, 0, 125, SDL_TRUE, {0, 270 }, 0};
	level_03.waves[0].wave_array[14] = (t_wave_elem){E_SLIME_BLUE, 0, 125, SDL_TRUE, {0, 270 - 45}, 0};
	...
	level_03.waves[2] = (t_wave){0, WAVE_PREV_DEFEAT, 0, SDL_FALSE, SDL_FALSE, 36, SDL_FALSE, NULL};
	...
	level_03.waves[2].wave_array[23] = (t_wave_elem){E_SLIME_BLUE, 0, 28 * t, SDL_TRUE, {0, 230}, 0};
	level_03.waves[2].wave_array[24] = (t_wave_elem){E_SLIME_BLUE, 0, 12 * t, SDL_TRUE, {0, 240}, 0};
	level_03.waves[2].wave_array[25] = (t_wave_elem){E_SLIME_BLUE, 0, 9 * t, SDL_TRUE, {0, 250}, 0};
	...
	level_03.waves[2].wave_array[32] = (t_wave_elem){E_SLIME_BLUE, 0, 4 * t, SDL_TRUE, {0, 320}, 0};
	level_03.waves[2].wave_array[33] = (t_wave_elem){E_SLIME_BLUE, 0, 31 * t, SDL_TRUE, {0, 330}, 0};
	level_03.waves[2].wave_array[34] = (t_wave_elem){E_SLIME_BLUE, 0, 2 * t, SDL_TRUE, {0, 340}, 0};
	level_03.waves[2].wave_array[35] = (t_wave_elem){E_SLIME_BLUE, 0, 14 * t, SDL_TRUE, {0, 350}, 0};
